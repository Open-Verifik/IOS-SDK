...
class ThemeHelpers {
    ...
    class func getCustomizationForTheme(theme: String) -> FaceTecCustomization {
        ...
        let fc1 = UIImage(named: "FaceTec_ideal_1", in: bundle, with: .none)
        let fc2 = UIImage(named: "FaceTec_ideal_2", in: bundle, with: .none)
        let fc3 = UIImage(named: "FaceTec_ideal_3", in: bundle, with: .none)
        let fc4 = UIImage(named: "FaceTec_ideal_4", in: bundle, with: .none)
        let fc5 = UIImage(named: "FaceTec_ideal_5", in: bundle, with: .none)
        
        let retryScreenSlideshowImages = [fc1!, fc2!, fc3!, fc4!, fc5!]
