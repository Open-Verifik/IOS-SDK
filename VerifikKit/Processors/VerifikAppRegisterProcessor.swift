//
//  VerifikAppRegisterProcessor.swift
//  VerifikKit
//
//  Created by Carlos Bleck on 23/01/23.
//
...
class VerifikAppRegisterProcessor: NSObject, Processor, FaceTecFaceScanProcessorDelegate, URLSessionTaskDelegate {
    ...
    func processSessionWhileFaceTecSDKWaits(sessionResult: FaceTecSessionResult, faceScanResultCallback: FaceTecFaceScanResultCallback) {
        ...
        //
        let request = NSMutableURLRequest(url: NSURL(string: VerifikURL.BaseKYC + VerifikURL.AppRegisterKYC)! as URL)
