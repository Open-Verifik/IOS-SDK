//
//  VerifikPhotoIDScanProcessor.swift
//  VerifikKit
//
...
class VerifikPhotoIDScanProcessor: NSObject, Processor, FaceTecIDScanProcessorDelegate, URLSessionTaskDelegate {
    ...
    func processIDScanWhileFaceTecSDKWaits(idScanResult: FaceTecIDScanResult, idScanResultCallback: FaceTecIDScanResultCallback) {
        ...
        //
        let request = NSMutableURLRequest(url: NSURL(string: VerifikURL.Base + VerifikURL.IDScan)! as URL)
    ...
    func onFaceTecSDKCompletelyDone() {
        ...
        self.fromViewController.onPhotoIDScan()
    }
